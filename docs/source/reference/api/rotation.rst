...
.. py:function:: getMatrixFromTo(orderFrom, anglesFrom, orderTo, anglesTo)
	...
	:param Order orderFrom:
	:param Angles anglesFrom:
	:param Order orderTo:
	:param Angles anglesTo:
	:return:
	:rtype: Matrix
...
.. py:function:: rotateAxisFrom(axis, angle, vector, *, offset)
...
.. py:function:: rotateAxisTo(axis, angle, vector, *, offset)
...
.. py:function:: rotateEulerFrom(order, angles, vector, *, offset)
...
.. py:function:: rotateEulerTo(order, angles, vector, *, offset)
...
.. py:function:: rotateMatrixFrom(matrix, vector, *, offset)
...
.. py:function:: rotateMatrixTo(matrix, vector, *, offset)
